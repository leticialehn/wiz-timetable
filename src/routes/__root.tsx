...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sistema de horários em tempo real para professoras e secretaria." },
      { property: "og:title", content: "Grade de Aulas — Escola de Idiomas" },
      { property: "og:description", content: "Grade semanal de aulas com atualização em tempo real." },
