...
export const Route = createFileRoute("/admin/relatorios_/carga-professoras")({
  component: CargaProfessorasPage,
});
...
function CargaProfessorasPage() {
  ...
  return (
    <main className="max-w-[1400px] mx-auto px-4 py-6">
      ...
      <h1 className="text-2xl font-semibold mb-4">Carga de professoras</h1>
