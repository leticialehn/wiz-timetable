...
| 1.6   | [Fix repo-wide `npm run lint`](1.6.fix-repo-wide-lint.md)                          | Draft               | @dev     |
...
`docs/estado.md`). Story 1.6 (repo-wide `npm run lint`, raised from QA-1.4-02) is now
**Draft**, ready for `@po *validate-story-draft`. The epic is still **not** closed:
